...
pub struct Configuration {
    ...
    spring_length: f64 = 3.0 * MICRO_METRE,
    ...
    spring_length_threshold: f64 = 6.0 * MICRO_METRE,
}}
...
#[pyfunction]
pub fn run_simulation(config: &Configuration) -> Result<(), SimulationError> {
    ...
    let delta_x = agent.mechanics.spring_length * n_vertices as f64;
